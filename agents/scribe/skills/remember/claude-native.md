...
| `~/.claude/agents/<name>.md` | Subagent identity — frontmatter + body as spawn prompt | Scribe (via register) |
...
- Subagents DO inherit CLAUDE.md (and its `@` imports) but do NOT inherit rules, or conversation history.

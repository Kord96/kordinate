...
def main() -> int:
    ...
    prompt = "\n".join([
        ...
        "When getting-started or other narrative-selection issues remain, use `facts/narrative-seeds.json` when present to challenge which roots, child stories, flow-bearing stories, and boundary stories actually deserve inclusion in the repo overview.",
        ...
        "When a narrative overview is too thin, rewrite `getting-started.description` as a compact repo overview that teaches system shape plus the operating model instead of a generic one-liner or component catalog.",

...
KORD = Path("/kord/workstation/home/project/kordinate/shared/skills/kord/scripts/kord")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Collect external-model reflections through kord and store them as Augur raw reflection records.")

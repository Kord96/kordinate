...
Validation:
- run:
  - `python3 /kord/workstation/home/project/kordinate/agents/augur/skills/analyze/scripts/validate_output.py /tmp/augur-ablation/jpos-v1/facts-no-memory`
- after each validation attempt, read `/tmp/augur-ablation/jpos-v1/facts-no-memory/repair-log.json`

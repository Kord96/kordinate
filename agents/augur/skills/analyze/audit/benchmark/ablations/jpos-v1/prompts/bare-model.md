...
Output directory:
- `/tmp/augur-ablation/jpos-v1/bare-model`
...
Validation:
- run:
  - `python3 /kord/workstation/home/project/kordinate/agents/augur/skills/analyze/scripts/validate_output.py /tmp/augur-ablation/jpos-v1/bare-model`

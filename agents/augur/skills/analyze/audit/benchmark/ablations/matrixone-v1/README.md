# MatrixOne Ablation Set v1

Use this set to measure which parts of Augur materially improve quality on a hard repo.
...
python3 /kord/workstation/home/project/kordinate/agents/augur/scripts/benchmark/run_ablation_codex.py \
  /kord/workstation/home/project/kordinate/agents/augur/skills/analyze/audit/benchmark/ablations/matrixone-v1/manifest.json \
  --model gpt-5.4
```
...
- `.../ablations/matrixone-v1/runs/<timestamp>/`

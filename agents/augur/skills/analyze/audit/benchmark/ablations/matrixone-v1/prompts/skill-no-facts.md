...
Output directory:
- `/tmp/augur-ablation/matrixone-v1/skill-no-facts`
...
Validation:
- run:
  - `python3 /kord/workstation/home/project/kordinate/agents/augur/skills/analyze/scripts/validate_output.py /tmp/augur-ablation/matrixone-v1/skill-no-facts`
- after each validation attempt, read `/tmp/augur-ablation/matrixone-v1/skill-no-facts/repair-log.json`

...
def recommended_artifacts(issue: dict) -> list[str]:
    ...
    mapping = {
        ...
        "narrative-count": ["observations/narratives.json", "narratives.yaml", "atlas.json"],
        "story-quality": ["observations/stories.json", "observations/components.json"],
        "component-model": ["observations/components.json", "observations/stories.json"],
        "flow-model": ["facts/symbols-seed.json", "observations/components.json"],
        "health-criteria-missing": ["observations/health.json", "atlas.json"],
        "health-scenario-link-missing": ["observations/failure-scenarios.json", "atlas.json"],
        "health-scenario-link-invalid": ["atlas.json", "observations/failure-scenarios.json"],
        "health-ownership-unclear": ["observations/components.json", "atlas.json"],
        "failure-scenario-missing": [
            "observations/failure-scenarios.json",
            "observations/health.json",
            "atlas.json",
        ],
        "health-model": ["observations/health.json", "atlas.json"],
        "monitoring-model": [
            "observations/health.json",
            "observations/failure-scenarios.json",
            "atlas.json",
        ...
        "concepts": ["observations/concepts.json"],

...
5. Use larger or noisier supporting domains such as `concept-evidence.json` only when they help confirm concepts, answer semantic questions, or resolve ambiguity.
...
- Use `concept-evidence.json` for concept confirmation work and semantic questions, not as the primary source of architectural grounding.

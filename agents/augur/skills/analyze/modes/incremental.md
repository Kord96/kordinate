...
3. If `concept-evidence.json` is present and carries semantic questions for affected concept candidates, answer them before finalizing `atlas.json.concepts`.

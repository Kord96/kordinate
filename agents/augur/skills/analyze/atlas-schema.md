    ...
    "detected_patterns": [
      {
        ...
        "evidence": {
          ...
          "files": ["<path>"],
          "components": ["<component-id>"],
          "fingerprint": "<sha256 over evidence files, fact ids, and components>",
...
- **Health should cover** every external dependency and every stateful component. Attach failure modes, detection signals, and instrumentation gaps to the entity they affect instead of using a detached top-level list.

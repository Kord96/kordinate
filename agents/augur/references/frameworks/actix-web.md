...
source:
  memory_framework: memory/catalog/frameworks/actix-web/framework.md
  semantics: memory/catalog/frameworks/actix-web/semantics.yaml
language: rust
...
## Recognition
Use the framework reference in `references/frameworks/` as the canonical shared explanation and signatures source. Deterministic detector policy or rules, when present, live under `detectors/frameworks/actix-web/`.

...
source:
  memory_framework: memory/catalog/frameworks/gin/framework.md
  semantics: memory/catalog/frameworks/gin/semantics.yaml
language: go
...
## Recognition
Use the framework reference in `references/frameworks/` as the canonical shared explanation and signatures source. Deterministic detector policy or rules, when present, live under `detectors/frameworks/gin/`.

...
2. Do the assigned task using your skills. Own the local validation and repair loop inside the skill when the workflow requires it. If sensitive content appears in outputs or notes, run `/sanitize` before publishing or storing them.

---
description: Rust web framework centered on typed routers and composable handlers
---
# Axum
...
## Recognition
Use the detector package under `detectors/facts/frameworks/axum/` as the deterministic source of truth for framework evidence.

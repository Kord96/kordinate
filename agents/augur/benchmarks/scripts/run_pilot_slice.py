...
EXTRACT_FACTS = ROOT / "detectors" / "scripts" / "extract_facts.py"
INFER_CONCEPTS = ROOT / "detectors" / "scripts" / "infer_concepts_from_facts.py"
PREPARE_SEMANTIC_REVIEW = ROOT / "scripts" / "run" / "prepare_semantic_review.py"
REFLECTION_PROMPT_PATH = ROOT / "skills" / "analyze" / "audit" / "prompts" / "reflection.md"

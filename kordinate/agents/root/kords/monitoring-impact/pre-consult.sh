#!/bin/bash
# Pre-consult check for monitoring-impact kord.
...
KORD_DIR="$KORDINATE_HOME/agents/root/kords/monitoring-impact"
PROVIDER_DIR="$KORDINATE_HOME/agents/sauron"
CACHE_FILE="$KORD_DIR/.cache-hash"

# Check if consultation result exists
CONSULT_PATTERN="$KORDINATE_HOME/agents/root/memory/dynamic/consultations/monitoring-impact.md"

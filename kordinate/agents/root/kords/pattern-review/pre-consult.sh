#!/bin/bash
# Pre-consult check for pattern-review kord.
...
KORD_DIR="$KORDINATE_HOME/agents/root/kords/pattern-review"
PROVIDER_DIR="$KORDINATE_HOME/agents/designer"
CACHE_FILE="$KORD_DIR/.cache-hash"

# Check if consultation result exists
CONSULT_PATTERN="$KORDINATE_HOME/agents/root/memory/dynamic/consultations/pattern-review.md"

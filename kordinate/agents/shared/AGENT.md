...
1. Read your curated knowledge at `paths.curated`
2. Read your operational notes at `paths.operational`
3. If in a project repo: read `paths.project` and check `paths.manifests` / `paths.monitoring`
4. Run `/boot`

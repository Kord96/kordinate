---
name: detect-concepts
description: Detect architectural concepts, anti-patterns, and gaps in a project's source code. Use for architecture review, codebase onboarding, debt audits, or before proposing refactors.
...
Scan a project's source code to identify which architectural concepts and anti-patterns are in use and produce a structured concepts report.

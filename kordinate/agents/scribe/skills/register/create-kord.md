...
Level 3 resource for the register skill. Define a new kord — a consultation contract between agents.

## Usage

```
/register kord deployer-sauron "pre-deployment health checks"
/register kord pattern-review "architecture review for deployment changes"
```

...
3. **Generate identity.md** — see [identity-template.md](identity-template.md) for the template.

4. **Write Claude native agent file** — see [claude-native.md](claude-native.md) for how to map identity.md to `~/.claude/agents/<name>.md`.

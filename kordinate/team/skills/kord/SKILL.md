...
3. SLEEP — before finishing, persist what you learned:
   - Scratchpad — append quick observations to your memory/scratchpad.md.
   - Topic files — if you discovered something worth its own file, write it to your memory directory.
...
Never pass the raw prompt to the agent.

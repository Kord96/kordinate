...
1. **Dedup check** (topic files only) — before creating a new topic file, check for duplicates. See [dedup.md](dedup.md) for the full procedure. Skip this step for scratchpad appends.
...
4. **Add frontmatter** — every memory file needs recall properties:
    ```yaml
    ---

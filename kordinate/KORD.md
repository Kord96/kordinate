...
- `agents/charon/memory/scratchpad.md` — Charon working notes and observations
- `agents/charon/memory/tools.md` — Charon tools reference — postgres.py and local utilities
...
- `agents/augur/memory/tools.md` — Augur tools reference — Gemini MCP for architecture validation
- `agents/augur/memory/workflow.md` — Augur review workflow — identify, compare, review, report
...
- `agents/charon/kords/cluster-topology/contract.md` — Cluster topology, service endpoints, and networking
- `agents/charon/kords/charon-default/contract.md` — General deployment and cluster questions
- `agents/charon/kords/deployment-status/contract.md` — Live deployment status — pods, versions, health
- `agents/charon/kords/setup-secrets/contract.md` — Create Kubernetes secrets from pass store for a specific cluster
- `agents/augur/kords/concept-lookup/contract.md` — Look up a specific architectural pattern or anti-pattern
- `agents/augur/kords/augur-default/contract.md` — General architecture and design questions
- `agents/augur/kords/pattern-review/contract.md` — Architecture review for deployment and monitoring changes

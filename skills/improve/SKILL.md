...
4. **The agent executes three phases**:
   ...
   - **Phase 3 — Sleep**: updates the repo database at `$DATA_DIR/repo-database.json`, persists portfolio findings and domain insights to memory via the `write_memory` tool, finalizes the manifest.

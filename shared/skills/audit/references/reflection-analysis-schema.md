...
Defines the shared analysis outputs that `/audit <target> --mode semantic` should consume when comparing stored reflections across models.
...
6. `/audit <target> --mode semantic --from-runs` reads those summaries

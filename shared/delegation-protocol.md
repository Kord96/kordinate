...
- **Reports and outputs**: Agents write results to their memory directories under `/kord/projects/kordinate/agents/<agent>/memory/`. Read these paths to retrieve detailed artifacts.

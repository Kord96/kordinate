...
function canonicalRepoPath(repo: string, rest: string): string | undefined {
...
export function canonicalizeWorkingDir(workingDir?: string): string | undefined {
  ...
  if (!matchedPrefix) return workingDir

...
const KORDINATE_HOME = process.env.KORDINATE_HOME || '/app';
...
const SHARED_GLOBAL_DIR = '/kord/shared/memory';
...
const sharedWatcher = createWatcher(SHARED_GLOBAL_DIR);
...
async function main() {
  log('info', 'agent_boot', { brokers: KAFKA_BROKERS, project_dir: AGENT_PROJECT_DIR, state_dir: AGENT_STATE_DIR, model: CLAUDE_MODEL });
